<?php
    ...
    class Feed extends Products{
        ...
        function __construct($_name, $_price, $_type, $_size, $_weight){
    ...
    $cibo_1 = new Feed ("royal canin plus", 10.99, [$animal_1], "Adulto", "750g");
    $cibo_2 = new Feed ("chip chip", 10.98, [$animal_4], "Qualsiasi", "200g");
